...
from deutschland.diga import rest
from deutschland.diga.configuration import Configuration
from deutschland.diga.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.diga.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.catalog_entry_get  # this is an instance of the class Endpoint
        api_instance.catalog_entry_get()  # this invokes api_instance.catalog_entry_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.catalog_entry_get.callable or self.callable in this class
